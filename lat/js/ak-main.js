...
// $("body").html($("body").html().replace(/Ї/g,'Ji'));
...
$("body").html($("body").html().replace(/Щ/g,'Sč'));
...
$("body").html($("body").html().replace(/’/g,'j'));
